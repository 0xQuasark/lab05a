...
function sum(a, b) { //eslint-disable-line
  let answer = [];
  answer.push(a+b);
  answer.push('The sum of ' + a + ' and ' + b + ' is ' + (a+b) +'.');
  return answer;
}
...
function multiply(a, b) { //eslint-disable-line
  let answer = [];
  answer.push(a*b);
  answer.push('The product of ' + a + ' and ' + b + ' is ' + (a*b) + '.');
  return answer;
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  answer.push(sum(sum(a, b)[0], c)[0]);
  answer.push(a + ',' + b + ',' + c + ' was passed in as an array of numbers, and ' + answer[0] + ' is their sum.');
  return answer;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  answer.push(multiply(multiply(a,b)[0], c)[0]);
  answer.push('The numbers ' + a + ',' + b + ',' + c + ' have a product of ' + answer[0] + '.');
